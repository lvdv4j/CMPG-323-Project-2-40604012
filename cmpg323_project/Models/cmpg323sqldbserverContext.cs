...
{
    public partial class cmpg323sqldbserverContext : DbContext
    {
        public cmpg323sqldbserverContext()
        {
        }

        public cmpg323sqldbserverContext(DbContextOptions<cmpg323sqldbserverContext> options)
            : base(options)
        {
        }
